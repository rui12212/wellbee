...
from . views import CheckInViewSet, CourseViewSet, VideoViewSet, ViewingRecordViewSet
...
router.register(r'viewing_record', ViewingRecordViewSet, basename='viewing-record')
