...
class RadarChartPage extends StatefulWidget {
  ...
  RadarChartPage({super.key, required this.surveyData});
              ...
              children: [
                        ...
                        RadarChartDataFixMinMax(
                          ...
                          radarTouchData: RadarTouchData(
                            touchCallback: (FlTouchEvent event,
                              ...
                              // グラフ以外の場所が押されたら-1をする＝選択を外す＝色やコンテナを元に戻す
                              if (response == null ||
                        ...
                        builder: (context, constraints) {
                          ...
                          return Stack(
                            children: List.generate(labels.length, (index) {
                              ...
                              return Positioned(
                                left: labelX - 70.h, // テキストの幅に応じて調整
                                top: labelY - 12.h, // テキストの高さに応じて調整
                                child: Container(
                                  // テキストの入るボックス
                                  width: 150.w,
                ...
                Column(
                  ...
                  children: getRawDataSets()
                      .asMap()
                      .map((index, value) {
                        // 特定のindexが現在選ばれているインデックス（selectedDataIndexと一緒かどうかを判定している
                        final isSelected = index == selectedDataSetIndex;
                        return MapEntry(
                          index,
                          // GestureDetectorがFITouchDataに負けて、下記のonTapが動作していない
                          // 必要なことは、FITouchDataにて作業
                          GestureDetector(
                            // onTap: () {
                            //   setState(() {
