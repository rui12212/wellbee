...
import 'package:wellbee/screens/staff/dm/message_list.dart';
...
class DMMessageSendPage extends ConsumerStatefulWidget {
  String userId;
  DMMessageSendPage({Key? key, required this.userId});

  @override
  _DMMessageSendPageState createState() => _DMMessageSendPageState();
}

class _DMMessageSendPageState extends ConsumerState<DMMessageSendPage> {
      ...
      try {
        ...
        if (response.statusCode == 201) {
          ...
          Navigator.of(context)
              .push(MaterialPageRoute(builder: (context) => DMListPage(userId: widget.userId)));
