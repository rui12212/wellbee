...
import 'package:wellbee/screens/staff/course_add/add_course.dart';
import 'package:wellbee/screens/staff/course_add/edit_course.dart';
      ...
      floatingActionButton: FloatingActionButton.large(
        ...
        onPressed: () {
          Navigator.of(context)
              .push(MaterialPageRoute(builder: (context) => CourseAddPage()));
        },
      ),
    );
  }
