...
class StaffPrivateMembershipConfirmPage extends StatefulWidget {
  ...
  @override
  _StaffPrivateMembershipConfirmPageState createState() =>
      _StaffPrivateMembershipConfirmPageState();
}

class _StaffPrivateMembershipConfirmPageState
    extends State<StaffPrivateMembershipConfirmPage> {
  String? token = '';
  int totalPrice = 0;
  int finalPrice = 0;
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _DetailRow(
                            title: 'Times:',
                            value: '${widget.membershipMap['times']} time',
                          ),
                          SizedBox(
                            height: 5.h,
                          ),
