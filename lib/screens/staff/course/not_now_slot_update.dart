...
class SlotAddPage extends StatefulWidget {
  ...
  SlotAddPage({Key? key, required this.courseList}) : super(key: key);
...
class _SlotAddPageState extends State<SlotAddPage> {
  ...
  String? token = '';
  String selectedStartTime = DateTime.now().hour.toString();
  String selectedEndTime = DateTime.now().hour.toString();
    ...
    try {
      ...
      var response = await Future.any([
        http.post(
          ...
          body: jsonEncode({
            "course": widget.courseList,
            "date": newDate.toIso8601String(),
            "start_time": selectedStartTime,
            "reason": selectedEndTime,
          }),
        ),
      ...
      if (response.statusCode == 201) {
        showSnackBar(Colors.green, 'Attendee created successfully.');
                          ...
                          child: TextButton(
                            style: ButtonStyle(
                              ...
                              shape: MaterialStateProperty.all<
                                ...
                                RoundedRectangleBorder(
                                  borderRadius:
                                      BorderRadius.circular(10), // 枠線の角を丸くする
                                ),
                              ),
                            ),
                            onPressed: () async {
